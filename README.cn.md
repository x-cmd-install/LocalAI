...
合计: **782,351** 行代码（覆盖前 5 种语言、共 **2182** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 520,571 | 45,842 | 42,444 | 1758 |
| Yaml | 75,453 | 776 | 820 | 106 |
| Jsx | 36,244 | 2,262 | 2,577 | 162 |
| Json | 29,732 | 0 | 2 | 120 |
| Css | 28,007 | 1,213 | 7,121 | 36 |

## 源代码

- **上游仓库**: <https://github.com/mudler/LocalAI>
- **官网**: <https://localai.io>
- **许可证**: MIT
...
- **Star**: 49,113 · **Fork**: 4,448 · **开放 issue**: 1,594 · **贡献者**: 251

## 累计统计

- **发布数**: 136 · **已合并 PR**: 4494 · **开放 PR**: 65 · **已关闭 issue**: 1498 · **开放 issue**: 96 · **提交数**: 7979

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-16 | 1 | 202 | 54 | 22 | 32 | 316 |
| last60d | 2026-07-17 | 4 | 367 | 61 | 60 | 44 | 792 |
| 90d | 2026-06-17 | 16 | 438 | 63 | 123 | 51 | 1215 |
| last180d | 2026-03-19 | 38 | 750 | 65 | 247 | 71 | 2118 |
| 360d | 2025-09-20 | 49 | 1324 | 65 | 416 | 76 | 3304 |
| last720d | 2024-09-25 | 76 | 2679 | 65 | 669 | 84 | 5310 |
...
LocalAI 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `LocalAI` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/LocalAI.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260915.yml` · 2026-09-15T05:25:43Z._
